...
typedef void (sh2_SensorCallback_t)(void * cookie, sh2_SensorEvent_t *pEvent, const struct device *dev);
...
int sh2_open(sh2_Hal_t *pHal,
             sh2_EventCallback_t *eventCallback, void *eventCookie, const struct device *dev);
 ...
 * @return SH2_OK (0), on success.  Negative value from sh2_err.h on error.
 */
int sh2_setSensorCallback(sh2_SensorCallback_t *callback, void *cookie, const struct device *dev);
