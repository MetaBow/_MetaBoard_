...
struct sh2_Hal_s {
    ...
    int (*open)(sh2_Hal_t *self, const struct device *dev);
    ...
    void (*close)(sh2_Hal_t *self, const struct device *dev);
    ...
    int (*read)(sh2_Hal_t *self, uint8_t *pBuffer, unsigned len, uint32_t *t_us, const struct device *dev);
    ...
    int (*write)(sh2_Hal_t *self, uint8_t *pBuffer, unsigned len, const struct device *dev);
