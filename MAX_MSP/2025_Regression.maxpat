...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 78.0, 483.0, 120.0, 23.0 ],
					"text" : "routepass print clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 726.0, 451.0, 150.0, 36.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 83.0, 379.5, 75.0, 51.0 ],
					"text" : "Store-Synth-Preset-Nr\n/CLEAR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 285.0, 152.0, 23.0 ],
					"text" : "append xydata paramsdata"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 487.0, 47.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 407.5, 47.0, 23.0 ],
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 651.0, 450.0, 50.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 379.5, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 651.0, 487.0, 53.0, 23.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 651.0, 517.0, 100.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.0, 432.5, 129.0, 17.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 14, "obj-14", "multislider", "list", 0.184, 0.264, 0.36, 0.464, 0.528, 0.592, 0.648, 0.752, 0.864, 0.976, 5, "obj-16", "live.gain~", "float", 0.0, 5, "<invalid>", "radiogroup", "int", 1, 5, "obj-37", "toggle", "int", 0, 5, "obj-53", "number", "int", 1 ]
						}
, 						{
							"number" : 2,
							"data" : [ 14, "obj-14", "multislider", "list", 0.624, 0.4, 0.176, 0.68, 0.344, 0.592, 0.32, 0.768, 0.44, 0.704, 5, "obj-16", "live.gain~", "float", 0.0, 5, "obj-8", "toggle", "int", 0, 5, "obj-37", "toggle", "int", 0, 5, "obj-53", "number", "int", 2 ]
						}
, 						{
							"number" : 3,
							"data" : [ 14, "obj-14", "multislider", "list", 0.904, 0.712, 0.52, 0.4, 0.336, 0.424, 0.32, 0.56, 0.44, 0.784, 5, "obj-16", "live.gain~", "float", 0.0, 5, "obj-8", "toggle", "int", 0, 5, "obj-37", "toggle", "int", 0, 5, "obj-53", "number", "int", 3 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 570.0, 140.0, 288.0, 259.0 ],
					"text" : "1. Select the parameters you wish to follow\n2. Find sounds you like (by playing around with 10 multislider parameters of  Chaotic Synthesizer)\n3. Store 2 or more presets\n4. Think of corresponding number of sensor positions\n5. Turn the Sensor-Gate ON, and ML-Gate OFF\n6. Put your sensor in the first position and select the stored preset 1 then press Training-Trigger\n7. Repeat this process for as many combinations of sensor position and Preset that you would like (ideally not less than 2, and not more than 4)\n8. Train the ML by pressing on FIT\n9. Switch ML-Gate from OFF to ON, and see how the system finds the position between the extremes you defined by pairing your sensor position with Synth-Preset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.0, 426.0, 150.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 671.5, 108.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 16.0, 176.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 584.0, 130.0, 21.0 ],
					"text" : "Sensor-Gate ON/OFF"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 16.0, 37.0, 37.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 584.0, 37.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 76.0, 30.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 426.0, 46.0, 46.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 8.0, 662.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 483.0, 46.0, 23.0 ],
					"text" : "uzi 100"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.5, 16.0, 125.0, 31.0 ],
					"style" : "Workshop",
					"text" : "© Davor Vincze \nadapted from Ted Moore"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 50.0, 169.0, 328.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 50.0, 169.0, 328.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 140.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.5, 140.0, 186.0, 36.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 8.0, 623.0, 134.0, 36.0 ],
					"text" : "ML-Gate (OFF = learn /ON=predict)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 190.0, 32.0, 23.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 140.0, 37.0, 37.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 623.0, 37.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 374.5, 452.0, 183.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 417.0, 139.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 374.5, 417.0, 94.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 221.0, 202.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 248.0, 39.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 707.0, 185.0, 31.0 ],
					"text" : "fit",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 452.0, 77.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 740.0, 84.0, 23.0 ],
					"text" : "clear all data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.0, 452.0, 82.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 740.0, 84.0, 23.0 ],
					"text" : "print datasets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 594.0, 103.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 594.0, 131.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 141.0, 652.0, 147.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 667.0, 121.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 551.0, 162.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 15.0, 517.0, 61.0, 23.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 462.5, 666.0, 174.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "buffer" ],
					"patching_rect" : [ 462.5, 631.0, 205.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 15.0, 700.0, 138.0, 23.0 ],
					"text" : "buffer~ xybuf @samps 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "buffer" ],
					"patching_rect" : [ 287.0, 112.0, 196.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 769.0, 48.25, 48.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 320.0, 708.0, 136.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 765.0, 185.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 320.0, 631.0, 132.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 493.0, 176.0, 125.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 456.0, 185.0, 125.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"size" : 10
				}
...
,
					"patching_rect" : [ 320.0, 666.0, 132.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 320.0, 317.0, 187.0, 83.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -1.0, -3.0, 201.0, 51.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, -3.0, 201.0, 51.0 ],
					"style" : "Workshop",
					"text" : "Regression"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 24.5, 390.0, 243.0, 390.0, 243.0, 63.0, 307.5, 63.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 24.5, 617.0, 24.5, 617.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 296.5, 186.0, 342.5, 186.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 384.0, 459.0, 384.0, 459.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 138.0, 644.0, 79.0, 644.0, 79.0, 662.0, 24.5, 662.0 ],
					"order" : 1,
					"source" : [ "obj-60", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 87.5, 659.0, 24.5, 659.0 ],
					"order" : 1,
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 138.0, 649.0, 138.0, 649.0, 138.0, 649.0, 150.5, 649.0 ],
					"order" : 0,
					"source" : [ "obj-60", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"midpoints" : [ 87.5, 537.0, 177.0, 537.0, 177.0, 591.0, 138.0, 591.0, 138.0, 639.0, 150.5, 639.0 ],
					"order" : 0,
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-24::obj-1" : [ "live.numbox[5]", "live.numbox[5]", 0 ],
			"obj-24::obj-11" : [ "live.tab[6]", "live.tab[1]", 0 ],
			"obj-24::obj-15" : [ "live.numbox[6]", "live.numbox[5]", 0 ],
			"obj-24::obj-16" : [ "live.numbox[15]", "live.numbox", 0 ],
			"obj-24::obj-17" : [ "live.text[1]", "live.text[1]", 0 ],
			"obj-24::obj-22" : [ "live.tab", "live.tab", 0 ],
			"parameterbanks" : 			{
